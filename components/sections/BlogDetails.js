            ...
            <div className="col-xl-8 col-lg-7">
              <div className="blog-details__left">
                <div className="blog-details__img">
                  <img src="/images/resource/news-details.jpg" title="WWI" />
                ...
                <div className="blog-details__bottom">
                  <p className="blog-details__tags">
                    {" "}
                    <span>Tags</span>{" "}
                    <Link href="/news-details">Technology</Link>{" "}
                ...
                <div className="comment-one">
                  ...
                  <div className="comment-one__single">
                    <div className="comment-one__image">
                      {" "}
                      <img
                        src="images/resource/testimonial-4.jpg"
                        title="WWI"
                      />{" "}
                    </div>
                  ...
                  <div className="comment-one__single">
                    <div className="comment-one__image">
                      {" "}
                      <img
                        src="images/resource/testimonial-5.jpg"
                        title="WWI"
                      />{" "}
                    </div>
                    <div className="comment-one__content">
              ...
              <div className="sidebar">
                ...
                <div className="sidebar__single sidebar__tags">
                  ...
                  <div className="sidebar__tags-list">
                    {" "}
                    <Link href="#">Consulting</Link> <Link href="#">Cyber</Link>{" "}
                    <Link href="#">Development</Link>{" "}
                    <Link href="#">Digital</Link> <Link href="#">Software</Link>{" "}
